...
interface Code128AndGS1128 {
     ...
     */
    fun setGS1128Mode(deviceId: String, mode: Code128AndGS1128Mode, callback: Callback<CommandResponse>)
     ...
     * @param callback Callback to receive [CommandResponse] or an error.
     */
    fun setGS1128ConversionMode(deviceId: String, mode: GS1128ConversionMode, callback: Callback<CommandResponse>)
