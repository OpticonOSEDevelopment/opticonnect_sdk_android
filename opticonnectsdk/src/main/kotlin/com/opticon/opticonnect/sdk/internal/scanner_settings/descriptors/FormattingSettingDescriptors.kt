...
internal object FormattingSettingDescriptors {
    val prefix = SymbologyFormattingCommandSetting(
        commandsBySymbology = mapOf(
    ...
    val suffix = SymbologyFormattingCommandSetting(
        commandsBySymbology = mapOf(
