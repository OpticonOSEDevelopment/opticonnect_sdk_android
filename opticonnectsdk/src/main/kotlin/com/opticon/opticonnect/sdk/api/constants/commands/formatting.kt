...
object FormattingCommands {
    ...
    const val UPC_A_PREFIX = "N1"
    const val UPC_A_ADDON_PREFIX = "M0"
    const val UPC_E_PREFIX = "N2"
    const val UPC_E_ADDON_PREFIX = "M1"
    const val EAN_13_PREFIX = "N3"
    const val EAN_13_ADDON_PREFIX = "M2"
    const val EAN_8_PREFIX = "N4"
    const val EAN_8_ADDON_PREFIX = "M3"
    ...
    const val JAPANESE_POSTAL_PREFIX = "[D5S"
    ...
    const val MACHINE_READABLE_VISA_B_PREFIX = "[DJL"
    ...
    const val JAPANESE_DRIVER_LICENSE_PREFIX = "[DKO"
    ...
    const val UPC_A_SUFFIX = "N6"
    const val UPC_A_ADDON_SUFFIX = "OO"
    const val UPC_E_SUFFIX = "N7"
    const val UPC_E_ADDON_SUFFIX = "O1"
    const val EAN_13_SUFFIX = "N8"
    const val EAN_13_ADDON_SUFFIX = "O2"
    const val EAN_8_SUFFIX = "N9"
    const val EAN_8_ADDON_SUFFIX = "O3"
